...
public class DatabaseConfiguration {
    ...
    public boolean instantiate() {
        ...
        User u1 = new User("test", "John", "Doe", "john@gmail.com", "123", LocalDate.of(1913, 6, 9), "", "desc", ROLE.READER);
        ...
        User u2 = new User("user", "Mike", "Oxlong", "mikey@gmail.com", "123", LocalDate.of(1913, 6, 9), "guy1.jpeg", "desc", ROLE.READER);
        shelves = new ArrayList<>();
        shelves.add(s21);
        shelves.add(s22);
        shelves.add(s23);
        ...
        Author auth1 = new Author("daisyMeRollin", "Joanne", "Rowling", "misBigJ@gmail.com", "pass123", LocalDate.of(1913, 6, 9), "rowling.jpeg", "desc", ROLE.AUTHOR, true);
        shelves = new ArrayList<>();
        shelves.add(s31);
        shelves.add(s32);
        shelves.add(s33);
        ...
        Author auth2 = new Author("tolkien", "John", "Ronald Reuel Tolkien", "tolkien@gmail.com", "pass123", LocalDate.of(1965, 7, 31), "tolkien.jpg", "desc", ROLE.AUTHOR, true);
        shelves = new ArrayList<>();
        shelves.add(s41);
        shelves.add(s42);
        shelves.add(s43);
        ...
        // ADMINS
        User admin1 = new User("Shef", "Gordon", "Ramsay", "admin@gmail.com", "123", LocalDate.of(1913, 6, 9), "gordon.jpeg", "desc", ROLE.ADMIN);
