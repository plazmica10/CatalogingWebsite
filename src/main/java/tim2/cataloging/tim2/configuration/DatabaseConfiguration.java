...
public class DatabaseConfiguration {
    ...
    public boolean instantiate() {
        ...
        Book b1 = new Book("0747532745", "Harry Potter and the Philosopher's Stone", "Photo", LocalDate.of(2000, 3,25), 223, "desc", 0);
        b1.setGenre(g5);
        ...
        Book b2 = new Book("0345339738", "The Fellowship of the Ring", "Photo", LocalDate.of(1954, 8,29), 423, "desc", 0);
        b2.setGenre(g5);
        ...
        Book b3 = new Book("123", "Harry Potter and the Chamber of Secretes", "Photo", LocalDate.of(1954, 8,29), 423, "desc", 0);
        b3.setGenre(g5);
